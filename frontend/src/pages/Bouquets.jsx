...
const MOCK_BOUQUETS = mockProducts.filter(p => p.category === 'Boquet');
const PAGE_SIZE = 12;

export default function Bouquets() {
    const [products, setProducts] = useState(MOCK_BOUQUETS);
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                params.append('categories', 'Boquet');
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '120px 24px 60px', minHeight: '100vh' }}>
            ...
            <header style={{ marginBottom: '40px', textAlign: 'center' }}>
                ...
                <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', maxWidth: '600px', margin: '0 auto 32px' }}>
                    Beautiful arrangements of the freshest blooms for every occasion.
                </p>
            </header>
