                        ...
                        <div className="pd-thumbnails">
                            {thumbList.map((img, idx) => (
                                <div
                                    ...
                                    role="button"
                                    tabIndex={0}
                                    onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); setMainImage(img); } }}
                                />
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="pd-info">
                        ...
                        <div className="pd-actions">
                            <div className="pd-action-row">
                                ...
                                <button type="button" className="pd-btn-add" onClick={handleAddToCart}>
                                    <span className="material-symbols-outlined">shopping_cart</span>
                                    Add to Cart
                                </button>
                            </div>
                            <div className="pd-action-row" style={{ marginTop: '0.75rem' }}>
                                <button type="button" className="pd-btn-wishlist" onClick={handleWishlist} title="Save to wishlist">
