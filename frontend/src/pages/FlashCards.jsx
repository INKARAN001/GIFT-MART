...
const MOCK_FLASH_CARDS = mockProducts.filter(p => p.category === 'Flash Cards');
const PAGE_SIZE = 12;

export default function FlashCards() {
    const [products, setProducts] = useState(MOCK_FLASH_CARDS);
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                params.append('categories', 'Flash Cards');
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '120px 24px 60px', minHeight: '100vh' }}>
            ...
            <header style={{ marginBottom: '40px', textAlign: 'center' }}>
                ...
                <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', maxWidth: '600px', margin: '0 auto 32px' }}>
                    Bright, colorful, and engaging cards designed to foster early learning and development.
                </p>
            </header>
