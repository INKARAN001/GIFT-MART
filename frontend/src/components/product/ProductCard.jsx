    ...
    return (
        ...
        >
            ...
            {product.customizable && (
                <div className="product-card-badge" style={{ position: 'absolute', top: '16px', right: '16px', zIndex: 10, background: 'linear-gradient(135deg, #b76e79 0%, #9e5a64 100%)', color: '#fff', padding: '4px 10px', borderRadius: 'var(--radius)', fontSize: '0.75rem', fontWeight: '700', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
                    Customizable
                </div>
            )}
