                ...
                <div style={{ padding: '24px', flex: 1, overflow: 'auto' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px' }}>
                        ...
                        <button
                            ...
                            onMouseOver={(e) => {
                                e.currentTarget.style.background = '#9e5a64';
                                e.currentTarget.style.transform = 'translateY(-1px)';
                                e.currentTarget.style.boxShadow = '0 6px 20px rgba(183, 110, 121, 0.4)';
                            }}
                            onMouseOut={(e) => {
                                e.currentTarget.style.background = '#b76e79';
                                e.currentTarget.style.transform = 'translateY(0)';
                                e.currentTarget.style.boxShadow = '0 4px 14px rgba(183, 110, 121, 0.35)';
                            }}
                        >
